...
- una **asignación estética** (`aes`): tenemos que indicar las variables que queremos mostrar, y que atributo estético va a representar sus valores. Esto puede ser a través del color, el tamaño, la transparencia, etc. 
